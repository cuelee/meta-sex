  ...
  dir_sm <- rep(1,10);dir_sm[c(1,2,4,5)]=0 
  ...
  if(TRUE){
    pdf(file = "/Users/cuelee/Dropbox/Cue_meta_sex/Figure2/Figure2_R.pdf",width=8,height=6)
    par(bg= "white")
    par(mfrow = c(2,2))
  ...
  pdf("/Users/cuelee/Dropbox/Cue_meta_sex/Figure2/Male.pdf",width=3,height=0.5)
  par(bg = 'white')
  par(mar=c(0,0,0,0))
  plot(c(1,3),c(0,0)
       ,xlim=c(0.1,2.9)
  ...
  pdf("/Users/cuelee/Dropbox/Cue_meta_sex/Figure2/Female.pdf",width=3,height=0.5)
  par(bg = 'white')
  par(mar=c(0,0,0,0))
  plot(c(1,3),c(0,0)
       ,xlim=c(0.1,2.9)
